...
with open(join(dirname(__file__), "formats/raw_table_column_config_format.json"), "r", encoding="utf8") as file_ptr:
...
class _raw_table_config_validator(base_validator):
    ...
    def _check_with_valid_database_config(self, field, value) -> None:
    ...
    def _check_with_valid_raw_table_column_config(self, field, value) -> None:
    ...
    def _check_with_valid_schema_config(self, field, value) -> None:
        ...
        if primary_key_count > 1:
            self._error(field, f"There are {primary_key_count} primary keys defined. There can only be 0 or 1.")

    def _check_with_valid_ptr_map_config(self, field, value) -> None:
    ...
    def _check_with_valid_file_folder(self, field, value) -> None:
        """Validate data file folder exist if validate is set."""
        self._isdir(field, value)

    def _check_with_valid_data_files(self, field, value) -> None:
    ...
    def _check_with_valid_delete_db(self, field, value) -> None:
        """Validate delete_db."""
    ...
    def _check_with_valid_delete_table(self, field, value) -> None:
        """Validate delete_table."""
        if value and (not self.document.get('create_table', False) or self.document.get('wait_for_table', False)):
            self._error(field, "delete_table == True requires create_table == True and wait_for_table == False")

    def _check_with_valid_create_db(self, field, value) -> None:
        """Validate create_db."""
    ...
    def _check_with_valid_create_table(self, field, value) -> None:
    ...
    def _check_with_valid_wait_for_db(self, field, value) -> None:
    ...
    def _check_with_valid_wait_for_table(self, field, value) -> None:
